...
<html lang="en">
   <head>
      <title>Lobby Of Hobby | Gallery</title>
      <meta charset="utf-8">
            ...
            <div class="container-fluid">
               <div class="row align-items-center">
                  <div class="col-6 col-xl-2" data-aos="fade-down">
                     <h1 class="mb-0"><a href="index.html" class="text-black h4 mb-0">Lobby of Hobby</a></h1>
                  </div>
                  <div class="col-12 col-md-8 d-none d-xl-block" data-aos="fade-down">
            ...
            <div class="container-fluid">
               ...
               <div class="demo-gallery">
                  <div id="lightgallery" class="row">
                     <?php
                        $big = glob("images/big-images/$id/*.jpg");
                        $small = glob("images/small-images/$id/*.jpg");
                          for ($i=0; $i<count($big); $i++)
                          {
                            $bigi = $big[$i];
                            $smalli = $small[$i];
                            echo "<div class='col-sm-6 col-md-4 col-lg-3 col-xl-2 item'  data-aos='fade' data-src='$bigi'>"; 
                            echo "<a href='#'  class='item-anchor'>";
                            echo "<img src='$smalli' alt='' class='img-fluid' height='162' width='195'>";
                            echo "</a>";
                            echo "</div>";
                          }
                        ?> 
